...
#导入读取配置文件的模板
from api_test.case.case5.__init__ import *
@ddt.ddt
class mytest(unittest.TestCase):  #继承unittest.TestCase这个类
    ...
    def setUpClass(self):        #需要配合@classmethod装饰器一起使用。（在所有用例前后总共各执行一次。）
        print(u'接口测试第五个接口开始调用')
    @ddt.data (*Api_Data_read(r'C:\Users\EDZ\Desktop\ziyuanbao\untitled2\api_test\case\case5\Api_data5.xlsx','Api_data'))
